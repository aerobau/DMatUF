...
class AboutViewController: UITableViewController {
    ...
    let contacts = ["floridadm@floridadm.org", "http://www.floridadm.org/overall", "352-265-7237\nhttps://ufhealth.org/shands-hospital-children-uf", "DM at UF, PO Box 100386, Gainesville, FL 32610."]
