...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.dancemarathon.Network" in the application's documents Application Support directory.
        ...
        do {
            ...
            if NSFileManager.defaultManager().fileExistsAtPath(url.path!) {
                ...
                do {
                    ...
                    try newCoordinator?.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: url, options: nil)
